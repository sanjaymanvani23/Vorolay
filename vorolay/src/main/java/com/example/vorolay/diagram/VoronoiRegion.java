package com.example.vorolay.diagram;




import com.example.vorolay.GrahamScan;
...
public class VoronoiRegion {
    ...
    private void prepareCenter() {
        ...
        path.computeBounds(mRectF);
        center_rect = new VoronoiPoint(mRectF.getCenter().getPointX(), mRectF.getCenter().getPointY());
    }
